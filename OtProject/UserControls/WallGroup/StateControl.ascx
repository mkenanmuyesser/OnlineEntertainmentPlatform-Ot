<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StateControl.ascx.cs"
    Inherits="OtProject.UserControls.StateControl" %>
...
<div style="width: 700px; height: 203; padding: 5px;">
    <div style="height: 45px;">
        ...
        <div style="width: 480px; float: left;">
            <asp:Label ID="Label1" runat="server" CssClass="lblclass4">Soru ipsum dolor sit amet, consectetur adipiscing elit. Morbi luctus nisi et orci euismod vitae molestie arcu aliquam. Phasellus gravida tincidunt tortor vel u</asp:Label>
        </div>
