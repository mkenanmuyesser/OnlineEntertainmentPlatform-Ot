<%@ Page Title="" Language="C#" MasterPageFile="~/WallMain.Master" AutoEventWireup="true"
    CodeBehind="Grp.aspx.cs" Inherits="OtProject.Grp" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="../UserControls/WallGroup/WallLeftControl.ascx" TagName="WallLeftControl"
    TagPrefix="uc1" %>
<%@ Register Src="../UserControls/WallGroup/GroupControl.ascx" TagName="GroupControl"
    TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="middlecontent" runat="server">
    ...
    <div id="contentdiv">
        ...
        <div id="middlecontentdiv">
            <uc2:GroupControl ID="grpControl" runat="server" />
        </div>
    </div>
</asp:Content>
