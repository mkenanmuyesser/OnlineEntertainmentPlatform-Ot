<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateGroupWindow.aspx.cs"
    Inherits="OtProject.Popups.CreateGroupWindow" %>
...
<body>
    ...
    <div>
        <span style="font-size: 16px">Yeni Grup Aç</span>
        <table class="lblclass">
            <tr>
                ...
                <td>
                    <telerik:RadTextBox ID="txtGroupName" runat="server" Skin="Forest" DisplayText=""
                        Width="400" Height="24px" Font-Size="9px" MaxLength="160"
                        TextMode="SingleLine">
                    </telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadTextBox ID="txtComment" runat="server" Skin="Forest" Width="400" Height="30"
                        Font-Size="9px" MaxLength="160" TextMode="MultiLine">
                    </telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadButton ID="btnGroup" runat="server" ToggleType="CustomToggle" ButtonType="ToggleButton"
                        AutoPostBack="false" CssClass="lblclass">
                        <ToggleStates>
                            <telerik:RadButtonToggleState Text="Herkese Açık" CssClass="lblclass" />
                            <telerik:RadButtonToggleState Text="Sadece Davetliler" CssClass="lblclass" />
                        </ToggleStates>
                    </telerik:RadButton>
                </td>
            </tr>
